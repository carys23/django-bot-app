...
from .models import Holiday, Continent, AsiaCountries, AfricaCountries, NorthAmericaCountries, EuropeCountries, AntarcticaCountries, AustraliaCountries, TypeHoliday, Temp, Result
